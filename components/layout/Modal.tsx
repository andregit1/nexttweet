...
function Modal({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-60">
        <div className="relative w-full lg:w-3/6 my-6 mx-auto lg:max-w-3xl h-full lg:h-auto">
          ...
          <div className="h-full lg:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-black outline-none focus:outline-none">
            ...
            <div className="flex items-center justify-between p-10 rounded-t">
              ...
              <button onClick={handleClose} className='p-1 ml-auto border-0 text-red-500 hover:opacity-70 transition'>
